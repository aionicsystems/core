...
export class Loan extends ethereum.SmartContract {
  ...
  try_assetDataFeedAddress(): ethereum.CallResult<Address> {
  ...
  dataFeedPrice(dataFeedAddress: Address): BigInt {
    let result = super.call(
      "dataFeedPrice",
  ...
  try_dataFeedPrice(dataFeedAddress: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "dataFeedPrice",
      "dataFeedPrice(address):(uint256)",
      [ethereum.Value.fromAddress(dataFeedAddress)],
