...
export class AssetEntity extends Entity {
  ...
  get latestProtocolPrice(): BigDecimal {
    let value = this.get("latestProtocolPrice");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set latestProtocolPrice(value: BigDecimal) {
    this.set("latestProtocolPrice", Value.fromBigDecimal(value));
  }
...
export class PairEntity extends Entity {
  ...
  get reserveAsset(): BigInt {
    let value = this.get("reserveAsset");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set reserveAsset(value: BigInt) {
    this.set("reserveAsset", Value.fromBigInt(value));
  }
  ...
  set reserveBase(value: BigInt) {
    this.set("reserveBase", Value.fromBigInt(value));
  }
...
export class TokenEntity extends Entity {
  ...
  get aggregators(): AggregatorEntityLoader {
    return new AggregatorEntityLoader(
      "TokenEntity",
      this.get("id")!.toBytes().toHexString(),
      "aggregators",
    );
...
export class AggregatorEntityLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): AggregatorEntity[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<AggregatorEntity[]>(value);
  }
}
