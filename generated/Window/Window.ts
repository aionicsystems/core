...
export class Window extends ethereum.SmartContract {
  ...
  getParam(param: Bytes): BigInt {
    let result = super.call("getParam", "getParam(bytes32):(uint32)", [
  ...
  try_getParam(param: Bytes): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getParam", "getParam(bytes32):(uint32)", [
      ethereum.Value.fromFixedBytes(param),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class LoanEntityEventCall extends ethereum.Call {
  get inputs(): LoanEntityEventCall__Inputs {
    return new LoanEntityEventCall__Inputs(this);
  }

  get outputs(): LoanEntityEventCall__Outputs {
    return new LoanEntityEventCall__Outputs(this);
  }
}

export class LoanEntityEventCall__Inputs {
  _call: LoanEntityEventCall;

  constructor(call: LoanEntityEventCall) {
    this._call = call;
  }
...
export class LoanEntityEventCall__Outputs {
  _call: LoanEntityEventCall;
...
export class SetParamCall extends ethereum.Call {
  get inputs(): SetParamCall__Inputs {
    return new SetParamCall__Inputs(this);
  }

  get outputs(): SetParamCall__Outputs {
    return new SetParamCall__Outputs(this);
  }
}

export class SetParamCall__Inputs {
  _call: SetParamCall;

  constructor(call: SetParamCall) {
    this._call = call;
  }
...
export class SetParamCall__Outputs {
  _call: SetParamCall;
