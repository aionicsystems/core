...
export class Window extends ethereum.SmartContract {
  ...
  issue(assetAddress: Address, wethAmount: BigInt): BigInt {
    let result = super.call("issue", "issue(address,uint256):(uint256)", [
  ...
  try_issue(
    ...
    let result = super.tryCall("issue", "issue(address,uint256):(uint256)", [
      ethereum.Value.fromAddress(assetAddress),
      ethereum.Value.fromUnsignedBigInt(wethAmount),
    ]);
    if (result.reverted) {
...
export class SetAssetParameterCall extends ethereum.Call {
  get inputs(): SetAssetParameterCall__Inputs {
    return new SetAssetParameterCall__Inputs(this);
  }

  get outputs(): SetAssetParameterCall__Outputs {
    return new SetAssetParameterCall__Outputs(this);
  }
}

export class SetAssetParameterCall__Inputs {
  _call: SetAssetParameterCall;

  constructor(call: SetAssetParameterCall) {
    this._call = call;
  }
...
export class SetAssetParameterCall__Outputs {
  _call: SetAssetParameterCall;
...
export class SetWindowParameterCall extends ethereum.Call {
  get inputs(): SetWindowParameterCall__Inputs {
    return new SetWindowParameterCall__Inputs(this);
  }

  get outputs(): SetWindowParameterCall__Outputs {
    return new SetWindowParameterCall__Outputs(this);
  }
}

export class SetWindowParameterCall__Inputs {
  _call: SetWindowParameterCall;

  constructor(call: SetWindowParameterCall) {
    this._call = call;
  }
...
export class SetWindowParameterCall__Outputs {
  _call: SetWindowParameterCall;
